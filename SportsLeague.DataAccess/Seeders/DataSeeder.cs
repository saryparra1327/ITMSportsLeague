...
public static class DataSeeder
{
    public static async Task SeedAsync(LeagueDbContext context)
    {
...

        {
            ...
            new() { Name="Deportivo Cali", City="Palmaseca", Stadium="Deportivo Cali" },
        ...
        var playersData = new (string First, string Last, PlayerPosition Pos, int Number)[][]//Esto es una matriz
                                                                                             //no una colección

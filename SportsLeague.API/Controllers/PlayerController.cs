...
namespace SportsLeague.API.Controllers
{
    ...
    public class PlayerController : ControllerBase
    {
        ...
        {
            var players = await _playerService.GetAllAsync();//Aqui en la var player se guarda une entidad 
            var playersDto = _mapper.Map<IEnumerable<PlayerResponseDTO>>(players);//aqui esa entidad se mapea para volverla un DTO

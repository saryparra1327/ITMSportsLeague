...
//PATCH se usa para UpdateStatus porque es una actualización parcial (solo cambiamos el estado,
//no toda la entidad).
//POST {id}/teams para inscribir un equipo es una acción que crea un recurso (TournamentTeam)
//anidado bajo el torneo.
//GET {id}/teams para consultar los equipos inscritos.
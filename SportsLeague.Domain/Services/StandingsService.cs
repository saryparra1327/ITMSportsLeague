...
public class StandingsService : IStandingsService
{
    ...
    public async Task<object> GetStandingsAsync(int tournamentId)//Obtener la tabla de posiciones para un torneo especifico
    ...
    public async Task<object> GetTopScorersAsync(int tournamentId)//Obtener la lista de los máximos goleadores pra un torneo
    ...
    public async Task<object> GetCardStatsAsync(int tournamentId)//Obtener las estadisticas de tarjetas para un torneo

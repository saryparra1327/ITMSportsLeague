...
public class TeamService : ITeamService
{
    ...
    {
        _logger.LogInformation("Retrieving all teams");//Obteniedno todos los equipos
        return await _teamRepository.GetAllAsync();//Invoco el método de la clase genérica
    }

    public async Task<Team?> GetByIdAsync(int id)//Aquí es donde el método de la clase genérica me devuelve
        //La lista de tipo IEnumerable
    {
